...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/al;->a:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Landroid/support/v4/app/al;->d:Ljava/lang/Object;

    return-void
.end method

.method public static a(Landroid/app/Notification$Builder;Landroid/support/v4/app/ai$a;)Landroid/os/Bundle;
    .locals 3

    invoke-virtual {p1}, Landroid/support/v4/app/ai$a;->a()I

    move-result v0

    invoke-virtual {p1}, Landroid/support/v4/app/ai$a;->b()Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {p1}, Landroid/support/v4/app/ai$a;->c()Landroid/app/PendingIntent;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/ai$a;->d()Landroid/os/Bundle;

    move-result-object v1

    invoke-direct {v0, v1}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p1}, Landroid/support/v4/app/ai$a;->g()[Landroid/support/v4/app/aq$a;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/ai$a;->e()Z
...
.method public static a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    sget-object v2, Landroid/support/v4/app/al;->a:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    sget-boolean v0, Landroid/support/v4/app/al;->c:Z
    ...
    :cond_0
    :try_start_1
    sget-object v0, Landroid/support/v4/app/al;->b:Ljava/lang/reflect/Field;
    ...
    sput-boolean v0, Landroid/support/v4/app/al;->c:Z
    :try_end_1
    ...
    sput-object v0, Landroid/support/v4/app/al;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, Landroid/support/v4/app/al;->b:Ljava/lang/reflect/Field;
